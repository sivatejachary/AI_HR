...
class WorkflowStep(Base):
    ...
    schedule_type: Mapped[Optional[str]] = mapped_column(String(50), default="IMMEDIATE")
    fixed_timestamp: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    relative_delay_minutes: Mapped[Optional[int]] = mapped_column(Integer, default=0)
    executor: Mapped[Optional[str]] = mapped_column(String(50), default="HUMAN_HR")
